function Initialize-TempoTrashfireUi {
    ...
    $script:status.Text = 'Hit A S D F on the line. Keep the crowd alive through each ugly phase.'
    ...
    $script:startButton.Text = 'Start Set'
    $script:startButton.Location = New-Object System.Drawing.Point(640, 338)
    ...
    $script:bestLabel.Text = 'Best set: 0 score / phase 1'
    ...
    $script:bestLabel.Location = New-Object System.Drawing.Point(640, 396)
    $script:form.Controls.Add($script:bestLabel)

    $script:recapLabel = New-Object System.Windows.Forms.Label
    $script:recapLabel.Text = 'Last set: none yet'
    ...
    $script:recapLabel.Location = New-Object System.Drawing.Point(640, 428)
    $script:form.Controls.Add($script:recapLabel)

    $script:titleLabel = New-Object System.Windows.Forms.Label
    $script:titleLabel.Text = 'Set title: garage opener'
    ...
    $script:titleLabel.Location = New-Object System.Drawing.Point(640, 486)
